...
* [open a pull request](https://github.com/Homebrew/brew/blob/master/docs/How-To-Open-a-Homebrew-Pull-Request.md#how-to-open-a-homebrew-pull-request-and-get-it-merged) and fix any failing tests
